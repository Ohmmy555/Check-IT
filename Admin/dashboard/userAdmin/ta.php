...
>>>>>>> Stashed changes
  ...
  <div class="content">
    <p class="text">เพิ่ม-ลบ รายชื่อTA</p>
  ...
  <div id="side-box">
    ...
    <div id="all-link-boxs">
        <div class="link-boxs">
            <a href="../userAdmin/teacher.html" class="side-link">
                <p id="techer-box"><span class="small">รายชื่อ </span><br> อาจารย์ </p>
            </a>
        </div>
        <div class="link-boxs">
            <a href="../userAdmin/ta.html" class="side-link">
                <p id="ta-box"><span class="small">รายชื่อ </span><br> TA </p>
            </a>
        </div>
        <div class="link-boxs">
            <a href="../userAdmin/std.html" class="side-link">
    ...
    <div id="delete-box">
        <a href="../delete/delete.php" class="side-link">
